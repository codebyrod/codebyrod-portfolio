...
const Portfolio = () => {
  return (
    <S.Container id='portfolio'>
        ...
        <S.BoxImg>
          <a href='https://codebyrod-jogodamemoria.netlify.app/' target="_blank" rel="noreferrer">
            <img src= {cardAfrica} alt=""/>
          </a>
          <a href='https://github.com/codebyrod/Harry-Potter'  target="_blank" rel="noreferrer">
            <img src= {cardHarry} alt=""/>
          </a>
          <a href='https://codebyrod-starwars.netlify.app/' target="_blank" rel="noreferrer">
          ...
          <a href='https://codebyrod-homeverse.netlify.app/movies' target="_blank" rel="noreferrer">
